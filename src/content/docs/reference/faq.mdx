...
- [asusctl/ROG GUI and supergfxctl](https://gitlab.com/asus-linux/asusctl)
- Various hardware enablement tools (Chromebooks, Raspberry Pis, Arduino, Coreboot utils, etc.)
