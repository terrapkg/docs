...
- [asusctl/ROG Control Center](https://github.com/OpenGamingCollective/asusctl)
- [Proton VPN](https://protonvpn.com/)
- [Signal Desktop](https://signal.org/)
- Various hardware enablement tools (Chromebooks, Raspberry Pis, Arduino, Framework-System, Coreboot utils, etc.)
...
We do market Terra in a way that some may feel provocative, but our intent is not to denigrate the work of others, but rather differentiate ourselves as a project.
...
[Subatomic] runs on JWT tokens, and only trusted employees of Fyra Labs have access. The secret changes once in a while (and no one has it). The GPG signing key lives separately from the actual repositories.
