...
Ship GUI apps with [appstream metadata](@docs/contributing/appstream) and desktop file.
...
<Aside title="Note" icon="comment-alt">Our AppStream guidelines are documented [here](@docs/contributing/appstream).</Aside>

All graphical applications that can be started by the user MUST provide a [desktop entry](@docs/contributing/guidelines#providing-your-own-desktop-file) and [AppStream MetaInfo](https://www.freedesktop.org/software/appstream/docs/chap-Quickstart.html#qsr-app-example) file. Other applications are also RECOMMENDED to do so.
