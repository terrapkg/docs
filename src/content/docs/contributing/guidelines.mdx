...
Install `.desktop` file to `%_appsdir` for graphical apps. [Guide here](./guidelines#providing-your-own-desktop-file).
...
For [Nim](#nim), use one of below. Also `%nim_c` = `%nim_build`, [see our macros](../srpm#nim).
