...
- Review our [packaging policies](@docs/contributing/policies).
- Review our [packaging guidelines](@docs/contributing/guidelines).
- Review our custom [SRPM macros](@docs/contributing/srpm), as these may be helpful to your package.
...
<Code code={`[1;32msudo dnf[97m install [0;97;mterra-mock-configs`} lang="ansi" inline />
...
1. Inside the folder, create `anda.hcl` and `<packagename>.spec`.
   ...
   - For more information, check out our [packaging policies](@docs/contributing/policies).
...
- Review our [policies](@docs/contributing/policies) and [guidelines](@docs/contributing/guidelines)
...
The system regarding automatic updates [are described here](@docs/contributing/autoupdate). Here is an overview:
