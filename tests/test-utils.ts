// File taken and modified from the Starlight repo: https://github.com/withastro/starlight/blob/main/docs/__a11y__/test-utils.ts
...
const config: Config = {
  ...
  // NOTE: If you are hacking on this file, for now reference the linked file in the attribution above for an idea of what to do.
  i18n: {
